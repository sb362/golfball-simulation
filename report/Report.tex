...
\end{equation} \cite{BerberanSantos1997}
...
Using data from Figure 3 of \cite{Alam2011}, Python was used to construct a quartic fit of drag coeffiecient as a function of Reynolds Number, as shown in Figure (5).\\
